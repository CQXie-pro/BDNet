...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=True, default='BDNet', help='model name, options: [Autoformer, Transformer, TimesNet]')
    ...
    parser.add_argument('--cut_freq', type=int, default=40)
    ...
    parser.add_argument('--station_lr', type=float, default=0.0008)
    parser.add_argument('--station_loss_ratio', type=float, default=0.5)
